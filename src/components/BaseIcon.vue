 ...
 * Add a new icon by dropping its inner SVG markup into the `icons` map below
 * (24×24 viewBox, stroke-based, uses currentColor).
 */
const icons: Record<string, string> = {
  ...
  droplet: '<path d="M12 2.5S5.5 9.4 5.5 14a6.5 6.5 0 0 0 13 0c0-4.6-6.5-11.5-6.5-11.5Z"/>',
  sparkle:
    '<path d="M12 3v4M12 17v4M3 12h4M17 12h4M6.3 6.3l2.8 2.8M14.9 14.9l2.8 2.8M17.7 6.3l-2.8 2.8M9.1 14.9l-2.8 2.8"/>',
  wrench:
    '<path d="M14.7 6.3a4 4 0 0 0 5.3 5.3l-8 8a2.8 2.8 0 0 1-4-4l8-8a4 4 0 0 0-1.3-1.3Z"/><path d="M14.7 6.3 18 3"/>',
...
const iconMarkup = (name: string) => icons[name] ?? ''
</script>
